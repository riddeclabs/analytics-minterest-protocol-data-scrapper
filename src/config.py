...
MAX_TREADS_FOR_USERS_FETCHING = int(env.get_optional("MAX_TREADS_FOR_USERS_FETCHING", "10"))
RETRIES_COUNT_FOR_USERS_FETCHING = int(env.get_optional("RETRIES_COUNT_FOR_USERS_FETCHING", "50"))
